...
export default function LoginPage() {
  ...
  return (
    <div className="auth-background h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className={`auth-panel space-y-6 py-8 auth-panel-pulse ${isEntering ? 'auth-panel-enter' : ''}`}>
        <div className="auth-holo-grid" aria-hidden="true" />
        <div className="space-y-2 text-center">
          <h2 className="auth-title text-3xl">Sign in to your account</h2>
          <p className="auth-subtitle text-sm">
            Continue building your career with opportunities
          </p>
          <p className="auth-meta text-xs">
            Or{' '}
        ...
        <form className="space-y-4" onSubmit={handleSubmit}>
            ...
            <div className="space-y-1 text-left">
              ...
              <div className="relative">
                <input
                  ...
                  onChange={handleChange}
                  className="glass-input py-2.5 text-sm pr-10"
                />
                <button
                  type="button"
          ...
          <button
            type="submit"
            disabled={loading}
            className="btn-primary auth-button w-full py-2.5 text-sm disabled:cursor-wait disabled:opacity-70"
          >
